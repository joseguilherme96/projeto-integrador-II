    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg bg-light">
            <ul class="navbar-nav">
                ...
                <li class="nav-item"><a href="index.php" class=" nav-link  cor-letra" tabindex="11">Cinema / </a></li>
                <li class="nav-item"><a href="literatura.php" class=" nav-link cor-letra" tabindex="12">Literatura / </a></li>
                <li class="nav-item"><a href="artigo-literatura.php" class="nav-link  cor-letra" tabindex="13">Artigo</a> </li>
            </ul>
        </nav>
        ...
        <section class="row">
            <h2 class="cor-letra" tabindex="16">Filmes inspirados em livros</h2>
            ...
            ?>
                ...
                <article class="row justify-content-center">
                    <figure class="col-12 col-sm-12 col-lg-12 text-start text-lg-end tabindex">
                    ...
                    <hgroup class="col-lg-5 tabindex">
                        <h4 class="cor-letra">Jogador Nº 1 | Crítica </h4>
                        <p class="cor-letra">A volta do Steven Spielberg moleque</p>
                    </hgroup>
                    <div class=" col-lg-3  text-center  mt-2">
                        <a href="" class="text-decoration-none text-light cor-botao p-1 tabindex">FICÇÃO CIENTIFICA</a>
                    </div>
                    <p class="col-8">Por <a href="../autores.php?#omelete" class="tabindex">Omelete</a> 19/03/2018</p>
                    ...
                    <h3 class="cor-letra col-8 tabindex">Disponíveis em</h3>
                    <a class="col-12"></a>
                    <a href="https://www.primevideo.com/dp/amzn1.dv.gti.78b680ff-76d5-f11d-300c-65263d116eaa?autoplay=0&ref_=atv_cf_strg_wb" class="col-1 tabindex" target="blank">
                        <figure>
                            <img src="img/icones-streaming/prime-video.png" class="img-fluid" alt="Logo Prime Video">
                        </figure>
                    </a>
                    <a href="http://www.youtube.com/watch?v=dGurgPE-wb8" class="col-1 tabindex" target="blank">
                        <figure>
                            <img src="img/icones-streaming/youtube.png" class="img-fluid" alt="Logo Youtube">
                        </figure>
                    </a>
                    <a href="https://tv.apple.com/br/movie/ready-player-one/umc.cmc.295lpojxtonf6dqc4za2i97lr?action=play" class="col-1 tabindex" target="blank">
                        <figure>
                            <img src="img/icones-streaming/apple-tv.png" class="img-fluid" alt="Logo Apple Tv">
                        </figure>
                    </a>
                    <a href="https://play.hbomax.com/page/urn:hbo:page:GX9q5dgf0LMILwgEAAAF0:type:feature?source=googleHBOMAX&action=open" class="col-1 tabindex" target="blank">
                        <figure>
                            <img src="img/icones-streaming/hbo-max-icon.jpg" class="img-fluid" alt="Logo HBO">
                        </figure>
                    </a>
                    <figure class="col-4 text-end tabindex">
                ...
                <article class="row justify-content-center">
                    <figure class="col-12 col-sm-12 col-lg-12 text-center tabindex">
                    ...
                    <a href="https://tv.apple.com/br/movie/ready-player-one/umc.cmc.295lpojxtonf6dqc4za2i97lr?action=play" class="col-1" target="blank">
                        <figure>
                            <img src="img/icones-streaming/apple-tv.png" class="img-fluid tabindex" alt="Logo Apple Tv">
                        </figure>
                    </a>
                    <a href="https://play.hbomax.com/page/urn:hbo:page:GX9q5dgf0LMILwgEAAAF0:type:feature?source=googleHBOMAX&action=open" class="col-1 tabindex" target="blank">
                        <figure>
                ...
                <article class="row  justify-content-center text-center">
                    ...
                    <div class="col-3">
                        <h4 class="cor-letra d-inline tabindex">Jogos Vorazes</h4>
                    </div>
                    ...
                    <div class="cor-botao col-5 col-sm-2 col-lg-2 text-center  mx-1 mt-2">
                        <a href="" class="text-decoration-none text-light tabindex">AÇÃO</a>
                    </div>
                    <div class="cor-botao col-5 col-sm-3 col-lg-2 text-center  mx-1 mt-2">
                        <a href="" class="text-decoration-none text-light tabindex">AVENTURA</a>
                    </div>
                    <hgroup class="col-lg-8 tabindex">
                    ...
                    <p>Por <a href="../autores.php?#caiocolleti" class="tabindex">Caio Coletti</a> <time datetime="2022-10-08">08/10/2022</time></p>
                    <p class="col-8 text-start tabindex">Não espere ver Jennifer Lawrence de volta às grandes franquias hollywoodianas. Participando do BFI London Film Festival [via Deadline], ela explicou por que deve se concentrar em projetos independentes daqui em diante.</p>
                    <p class="col-8 text-start tabindex">"Franquias são muito divertidas, mas eu não conseguiria fazer uma agora. Estou muito velha e frágil", brincou a estrela de 32 anos, que já protagonizou sagas como Jogos Vorazes e X-Men.</p>
                    <p class="col-8 text-start tabindex">Falando mais sério, Lawrence caracterizou o seu retorno às telas com Não Olhe Para Cima e Causeway como uma "retomada de controle" após os superestrelato trazido pelos blockbusters e pelo Oscar (vencido por O Lado Bom da Vida).</p>
                    <p class="col-8 text-start tabindex">"Naquela época, senti que havia me tornado um produto. Cada decisão que eu tomava era na verdade uma decisão em grupo. Eu não fazia ideia do que era esperado uma estrela de cinema gigante, ou do que Katniss Everdeen deveria fazer a seguir... Quando penso naqueles anos hoje em dia, sinto uma perda de controle", comentou.</p>
                    <p class="col-8 text-start tabindex">Jennifer Lawrence fala de disparidade salarial em Não Olhe Para Cima Os próximos projetos de Lawrence incluem a comédia No Hard Feelings, coestrelada por Matthew Broderick; e uma reunião com Adam McKay, diretor de Não Olhe Para Cima, no thriller inspirado em história real Bad Blood.</p>
                    <h3 class="cor-letra col-8 tabindex">Disponíveis em</h3>
                    <a class="col-12"></a>
                    <a href="https://www.primevideo.com/dp/amzn1.dv.gti.78b680ff-76d5-f11d-300c-65263d116eaa?autoplay=0&ref_=atv_cf_strg_wb" class="col-1 tabindex" target="blank">
                        <figure>
                ...
                <article class="row justify-content-center">
                    ...
                    <div class="row  justify-content-center">
                        <div class="col-3">
                            <h4 class="cor-letra d-inline tabindex">Senhor dos Anéis</h4>
                        </div>
                        <div class="cor-botao col-5 col-sm-3 col-lg-2 text-center mt-2">
                            <a href="" class="text-decoration-none text-light tabindex">AVENTURA</a>
                        </div>
                        <div class="cor-botao col-5 col-sm-2 col-lg-2 text-center  mx-1 mt-2">
                            <a href="" class="text-decoration-none text-light tabindex">ÉPICO</a>
                        </div>
                        <div class="cor-botao col-5 col-sm-3 col-lg-2 text-center  mx-1 mt-2">
                            <a href="" class="text-decoration-none text-light tabindex">FANTASIA</a>
                        </div>
                    </div>
                    <hgroup class="col-8 tabindex">
                    ...
                    <p class="col-8">Por <a href="../autores.php?#omelete" class="tabindex">Omelete</a> 01/12/2022</p>
                    <p class="col-8 tabindex">O Prime Video aproveitou a manhã de hoje (1) para anunciar as novas adições do elenco de O Senhor dos Anéis: Os Anéis de Poder. Em formato de fio, a plataforma, aos poucos, revelou o nome dos 7 atores que se juntarão à produção na a próxima temporada.</p>
                    <p class="col-8 tabindex">A primeira divulgação foi a do ator Gabriel Akuwudike (Game of Thrones); veja: </p>
                    <p class="col-8 tabindex">Alguns instantes depois, o perfil na rede social também confirmou as escalações de Yasen ‘Zates’ Atour (The Witcher), Ben Daniels (The Exorcist), Amelia Kenworthy, Nia Towle (Persuasão) e Nicholas Woodeson (Roma). Até o momento, os atores seguem sem personagens divulgados. </p>
                    <p class="col-8 tabindex">Além disso, a plataforma também divulgou que o papel de Adar, líder dos Orcs, agora, será interpretado por Sam Hazeldine (Slow Horses), que substitui Joseph Mawle.</p>
                    <p class="col-8 tabindex">O Senhor dos Anéis: Os Anéis de Poder inicia filmagens da segunda temporada</p>
                    <p class="col-8 tabindex">Elenco se pronuncia contra ataques racistas
