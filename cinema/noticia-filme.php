    ...
    <div class="container ">
        <nav class="navbar navbar-expand-lg bg-light">
            <ul class="navbar-nav">
                ...
                <li class="nav-item"><a href="indexcinema.php" class="cor-letra" tabindex="11">Cinema / </a></li>
                <li class="nav-item"><a href="filmes.php" class="cor-letra" tabindex="12">Filmes / </a></li>
                <li class="nav-item"><a href="noticia-filme.php" class="cor-letra" tabindex="13">Noticia</a></li>
            </ul>
        </nav>
        ...
        <h2 class="row justify-content-center text-center cor-letra tabindex" id="noticia-filme">Noticia Filme</h2>
        <section class="row">
            <?php        
                if($_GET['cod']==1){
            ?>
            <h2 class="cor-letra tabindex">Indiana Jones</h2>
            <article class=" row justify-content-center">
                <figure class="col-12 col-sm-12 col-lg-12 tabindex">
                ...
                <h5 class=" col-10 col-lg-5 my-lg-1 cor-letra tabindex" id="noticia">Indiana Jones e o Chamado do Destino ganha título e trailer na CCXP22</h5>
                <div class="col-4 col-lg-2 my-lg-3 border cor-botao text-light tabindex">LANÇAMENTO</div>
                <div class="col-2 col-lg-1 my-lg-3 border cor-botao text-light tabindex">AÇAO</div>
                <p class="col-8">Por <a href="../autores.php?#nicogarofalo" class="tabindex">NICO GARÓFALO</a><time datetime="2022-12-01">01/12/2022</time></p><!--https://www.omelete.com.br/autores/nico-garofalo -->
                <p class="col-8 tabindex">Indiana Jones está de volta! Durante a CCXP22, o quinto filme do arqueólogo mais amado da cultura pop teve seu primeiro trailer revelado. Além de trazer o retorno de Harrison Ford a um dos papéis mais icônicos de sua carreira depois de 14 anos, a prévia revelou também o título oficial da nova sequência: Indiana Jones e o Chamado do Destino. Assista acima:</p>
                <p class="col-8 tabindex">O quinto Indiana Jones contará com o retorno de Harrison Ford ao lado de um elenco repleto de estrelas formado por Antonio Banderas, Phoebe Waller-Bridge, Mads Mikkelsen, Boyd Holbrook e Thomas Kretschmann.</p>
                <p class="col-8 tabindex">A direção ficou com James Mangold, de Logan e Ford vs. Ferrari. Esta será a primeira vez que um filme da franquia Indiana Jones não é dirigido por Steven Spielberg. John Williams, que criou o tema para Os Caçadores da Arca Perdida em 1981, também está encarregado da trilha sonora do novo longa.</p>
                <p class="col-8 tabindex">Indiana Jones e o Chamado do Destino deve chegar aos cinemas em 30 de junho de 2023.</p>
                ...
                <p class="col-8 tabindex">A CCXP22 acontece de 1 a 4 de dezembro e os ingressos podem ser adquiridos no site Mundo Ticket.</p>  
            </article>
            <?php } ?>
            <?php  
                if($_GET['cod']==2){
            ?>
            <article class="row justify-content-center">
                <figure class="text-center col-12 col-sm-12 col-lg-12 tabindex">
                ...
                <hgroup class="col-8 col-lg-8 py-3 tabindex" id="noticia">
            ...
            <article class="row justify-content-center">
                ...
                <hgroup class="col-8 py-3 tabindex" id="noticia">
                ...
                <p class="col-8">Por <a href="../autores.php?#giovannabreve" class="tabindex">GIOVANNA BREVE E NICOLAOS GARÓFALO</a><time datetime="2022-03-03">03/12/2022</time></p><!--https://www.omelete.com.br/autores/nico-garofalo -->
                <p class="col-8 tabindex">The Last of Us, série da HBO Max que adapta o game, ganhou um novo trailer na CCXP22 no Palco Thunder by Cinemark Club. A novidade veio com a presença do elenco de estrelas Pedro Pascal, Bella Ramsey, Gabriel Luna, Merle Dandrigge e os produtores execultivos Craig Mazin e Neil Druckmann. Confira acima.</p>
                <p class="col-8 tabindex">A prévia mostra um compilado de imagens de Joel, Ellie e Marlene em cenários bastante conhecidos para os familiarizados com o jogo. As cenas variam entre a cidade de Boston, a floresta, o shopping e, pela primeira vez, vemos de perto um clicker. A trailer foca também nos vínculos e conflitos que Joel enfrenta ao aceitar a missão de levar a Ellie.</p>
            ...
            <article  class="row justify-content-center">
                ...
                <p class="col-8">Por <a href="../autores.php?#caiocolleti" class="tabindex">CAIO COLETTI</a><time datetime="2022-03-18">18/03/2022</time></p><!--https://www.omelete.com.br/autores/nico-garofalo -->
            ...
            <article class="row justify-content-center">
                ...
                <p class="col-8">Por <a href="../autores.php?#omelete" class="tabindex">Omelete.</a><time datetime="2022-04-26" >26/04/2022</time></p><!--https://www.omelete.com.br/autores/nico-garofalo -->
                <p class="col-8 tabindex">A Netflix liberou nesta terça-feira (26) novas imagens de seu mais novo filme original, Agente Oculto, mostrando os personagens de Chris Evans, Ryan Gosling, Ana de Armas e Regé-Jean Page</p>
                <p class="col-8 tabindex">Na trama, Ryan Gosling é o agente da CIA Court Gentry, também conhecido como Agente Oculto e Sierra Six, enquanto Chris Evans é seu adversário psicopata Lloyd Hansen. O longa é baseado no livro The Gray Man, de Mark Greaney.</p>
                <p class="col-8 tabindex">Leia a sinopse do título: "Arrancado de uma penitenciária federal e recrutado por Donald Fitzroy (Billy Bob Thornton), Gentry já foi um mercenário altamente qualificado e sancionado pela Agência. Mas agora a situação virou e ele é o alvo, caçado em todo o mundo por Hansen, um ex-membro da CIA que não vai parar por nada até derrubá-lo. A seu favor, Six conta com a ajuda da agente Dani Miranda (Ana de Armas). Ele vai precisar."</p>
                <p class="col-8 tabindex">Dirigido pelos irmãos Anthony e Joe Russo, o filme ainda conta com Billy Bob Thornton, Jessica Henwick, Dhanush, Alfred Woodard e o brasileiro Wagner Moura no elenco. 
            </article>
            <?php 
                }
            ?>
