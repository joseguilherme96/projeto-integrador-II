<section class="row justify-content-center">
  ...
  <article class="col-lg-8  justify-content-center">
      <hgroup class="col-lg-8">
        ...
        <h5 class="cor-letra-D2D2D2">Personagens dos atores não foram revelado</h5>
      </hgroup>
      <p>Por <a href="../autores.php?#omelete">Omelete</a>  28/10/20222</p>
  ...
  <article class="col-lg-8  justify-content-center">
      ...
      <p>Por <a href="../autores.php?#caiocolleti">Caio Coletti</a>  08/10/20222</p>
  ...
  <article class="col-lg-8  justify-content-center">
      ...
      <p>Por <a href="../autores.php?#omelete">Omelete</a>  04/12/20222</p>
  ...
  <article class="col-lg-8 justify-content-center">
      <hgroup class="col-lg-8">
        ...
        <h5 class="cor-letra-D2D2D2">Apresentação do estúdio no Palco Thunder mostrou prévias de Homem-Formiga e a Vespa: Quantumania e Guardiões da Galáxia vol. 3</h5>
      </hgroup>
      <p>
  ...
  <article class="col-lg-8 justify-content-center">
      <hgroup>
        ...
        <h5 class="cor-letra-D2D2D2">Série estreia na HBO Max em 15 de janeiro</h5>
      </hgroup>
      <p>
