  ...
  <div class="container">
    <nav class="navbar navbar-expand-lg bg-light">
      <ul class="navbar-nav">
        ...
        <li class="nav-item"><a href="entrevistas.php" class="nav-link cor-letra">Entrevistas</a></li>
      </ul>
    </nav>
    ...
    <section class="row">
      ...
      <article class="col-12 col-sm-6 col-lg-4 p-1">
        ...
        <figure class="row">
          ...
          <figcaption class="d-none">Foto do autor Jason Sthan</figcaption>
        </figure>
        ...
        <a href="entrevista-com-autores.php?#jasonsthan" class="d-block text-end">Ler Mais</a>
      </article>
      <article class="col-12 col-sm-6 col-lg-4 p-1">
        <h2 class="cor-letra">Vin Diesel</h2>
        <figure class="row">
          <img src="img/vin-diesel.jpg" class="img-fluid" alt="Foto Autor">
          <Figcaption class="d-none">Foto do autor Vin Diesel</Figcaption>
        </figure>
        <p>Vin diesel fala sobre o filme Reativado que estreiou no dia 19 de janeiro.</p>
        <a href="entrevista-com-autores.php?#vindiesel" class="d-block text-end">Ler Mais</a>
      </article>
      <article class="col-12 col-sm-6 col-lg-4 p-1">
        ...
        <a href="entrevista-com-autores.php?#camillerowe" class="d-block text-end">Ler Mais</a>
      </article>
      <article class="col-12 col-sm-12 col-lg-12 p-1">
        ...
        <a href="entrevista-com-autores.php?#audreytautou" class="d-block text-end">Ler Mais</a>
      </article>
    </section>
  </div>
