...
<?php include "../header.php"?>
    ...
    <div class="container">
        ...
        <Section class="row">
            ...
            <h2 class=" text-start d-inline cor-letra  p-3 col-10">Lançamentos:</h2>
            <article class="col-12 col-sm-6 p-3 text-center">
                ...
                <p>A Netflix anunciou no Tudum,evento de anúncios da Netflix, a data de estreia da 4ª Temporada, que será dividida em duas partes: a primeira leva de episódios está marcada para 10 de fevereiro, 
                    ...
                    Estrelada por Penn Badgley You teve sua estreia em 2018 e acompanha um carismático psicopata stalker, e os métodos que usa para se aproximar de suas vítimas.
                ...
                <a class="text-decoration-none blue" href="../autores.php?#juliasabbaga"><p>Júlia Sabbaga 24/09/2022.</p></a>
            </article>
            <article class="col-12 col-sm-6 cor-fundo p-3 text-center ">
                ...
                <a class="text-decoration-none blue" href="../autores.php?#pedrohenriqueribeiro"><p>Pedro Henrique Ribeiro,24/09/2022.</p></a>
            </article>
            <div class="text-end">
