  ...
  <body>
    ...
    <section class="row pt-5 "> 
      ...
      <div class="col-12 col-sm-6 col-lg-12 pt-5 pb-5 text-start "> 
        <h1>Raina Telgemeier: um mergulho na adolescência com Drama e Coragem</h1> 
      ...
      <div class="col-12 col-sm-6 col-lg-12 pt-5 pb-5 text-start " > 
        <h1>Stefan Petrucha: a verdade está nas páginas dos quadrinhos</h1>
    ...
    <section class="row pt-5 "> 
      ...
      <div class="col-12 col-sm-6 col-lg-12 pt-5 pb-5 text-start" > 
        <h1>Jeff Smith: Bone e a longa jornada épica do “faça você mesmo”</h1>
