  ...
  <main>
    <section>
        ...
        <article class="row pt-5 ">
           <figure class="col-12 col-sm-12 col-lg-6 text-center pt-5 ">
            ...
            <div class="col-12 col-sm-12 col-lg-6 pt-5 pb-5 text-start ">
                     <h2 class="cor-letra">Desenhão: batalha de desenhos ao vivo premiará artista com um iPad Pro</h2>
      ...
      <article class="row pt-5 ">
         ...
         <div class="col-12 col-sm-12 col-lg-6  pt-5 pb-5 text-start ">
                 <h2 class="cor-letra">Formosa Márcia vence o Prêmio Jabuti na categoria História em Quadrinhos</h2>
      ...
      <article class="row pt-5 ">
        <figure class="col-12 col-sm-12 col-lg-6 pt-5 text-center">
             ...
             <div class="col-12 col-sm-12 col-lg-6 pt-5 pb-5 text-start">
                     <h2 class="cor-letra">História em quadrinhos sobre Paulo Freire em campanha no Catarse</h2>
