...
<?php include "../header.php"?>
 ...
 <main>
  ...
  <section class="row pt-5 ">
      ...
      <h1 class="col-12 cor-letra text-center" tabindex = "0" >Materia</h1>

      <article>
   
        <figure tabindex = "0" class="col-12 col-sm-12 col-lg-12 text-center pt-5 ">
    ...
    <article class="row pt-5 ">
      ...
      <div class=" row col-12 col-sm-12 col-lg-12 pt-5 pb-5 text-start ">
        <h2 tabindex = "0" class="cor-letra">Guia dos lançamentos de quadrinhos na CCXP22</h2>
        <p tabindex = "0">Após três anos, a CCXP volta a ser presencial e é aguardada com ansiedade por fãs e profissionais. O evento ocorre entre 1º e 4 de dezembro e, como sempre, um dos destaques será o Artists' Valley (antigo Artists' Alley), que receberá mais de 482 autores de todo o Brasil e do exterior, divididos em 356 mesas vendendo seus trabalhos. E vários deles serão lançados na CCXP.
          ...
          Como muitas pessoas pelo Brasil não poderão ir à CCXP, sempre que possível incluímos links de lojas online ou contatos de autores para comprar as publicações pela internet, e assim também aproveitar os materiais. </p>
          <a class="text-decoration-none cor-letra" href=" ../autores.php?#samirnaliato">
            <p class="blue">Samir Naliato, <time datetime="2022-12-02">02/12/2022.</time></p>
          </a>
      </div>
    ...
    <article class="row pt-5 ">
      ...
      <div class="col-12 col-sm-12 col-lg-6 pt-5 pb-5 text-start ">
        <h2 tabindex = "0" class="cor-letra">Do Cruzeiro Novo ao Real: 50 anos de economia brasileira com a revista Mônica</h2>
        <p tabindex = "0">Comemorando 50 anos em 2020, Mônica é o gibi há mais tempo publicado ininterruptamente no Brasil. São mais de 600 edições, sem deixar de estar nas bancas nem um único mês. A revista possui uma estabilidade que impressiona: praticamente não mudou desde sua estreia, salvo um aumento de 64 para 80 páginas, em 1984.
          ...
          <a class="text-decoration-none cor-letra" href=" ../autores.php?#renatofelix">
            <p class="blue" >Renato Felix,<time datetime="2020-12-29">29/12/2020.</time></p> </a>
      </div>
    </article>
    ...
    <article class="row pt-5 ">
      ...
      <div class="col-12 col-sm-12 col-lg-6 pt-5 pb-5 text-start">
        <h2 tabindex = "0" class="cor-letra">Relembrando as HQs do Mestre de Kung Fu</h2>
        <p tabindex = "0"> Shang Chi, o Mestre do Kung Fu, surgiu em dezembro de 1973, nas páginas da revista bimestral Special Marvel Edition # 15, da Marvel Comics.
          ...
          <a class="text-decoration-none cor-letra" href=" ../autores.php?#sergiocodespoti">
            <p class="blue" >Sergio Codespoti,<time datetime="2018-08-05">05/08/2018.</time> </p> </a>
      </div>
    </article>
