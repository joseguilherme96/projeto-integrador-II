...
<?php include "../nav.php"?>
  <div class="container "> 
    ...
    <div class="row text-center pt-5 pb-5  "> 
        ...
        <div  class="col-4 col-sm-4 col-lg-4 pt-5 ">  <h6 class="cor-letra" > God of War 5 </h6 > <a href="https://www.playstation.com/pt-br/games/god-of-war-ragnarok/" > <img src="/projeto-integrador-II/imgcosplay//godofwarragnarokgames.png" alt="God of War Ragnarök é um jogo eletrônico de ação-aventura desenvolvido pela Santa Monica Studio e publicado pela Sony Interactive Entertainment. Foi lançado em 9 de novembro de 2022 para PlayStation 4 e PlayStation 5. É o nono título da série God of War, o nono em ordem cronológica, e a sequência de God of War.">  </a> </div> 
      
        <div class="col-4 col-sm-4 col-lg-4 pt-5 "> <h6 class="cor-letra">Horizon Forbidden  </h6> <a href="https://www.playstation.com/pt-br/games/horizon-forbidden-west/"> <img src="/projeto-integrador-II/imgcosplay//horizonforbiden.png" alt="Horizon Forbidden West é um jogo eletrônico de RPG de ação desenvolvido pela Guerrilla Games e publicado pela Sony Interactive Entertainment. Foi lançado em 18 de fevereiro de 2022 para PlayStation 4 e PlayStation 5."> </a> </div>
    ...
    <div class="row pt-5 pb-5 pt-5 ">
    
        <div class="col-4 col-sm-4 col-lg-4 " >  <h6 class="cor-letra"> Forza Horizon 5 </h6> <a href="https://www.xbox.com/pt-BR/games/store/forza-horizon-5-edicao-padrao/9NKX70BBCDRN/0010"  > <img src="/projeto-integrador-II/imgcosplay//forza.png" alt="Forza Horizon 5 é um jogo eletrônico de corrida desenvolvido pela Playground Games e publicado pela Xbox Game Studios. É o quinto jogo da série Forza Horizon e o décimo segundo título principal da franquia Forza. O jogo se passa em uma representação ficcional do México. "> </a> </div>


        <div class="col-4 col-sm-4 col-lg-4 " > <h6 class="cor-letra"> The Last of Us 2    </h6>  <a href="https://store.playstation.com/pt-br/product/UP9000-CUSA07820_00-THELASTOFUSPART2"><img src="/projeto-integrador-II/imgcosplay//thelastofusgames.png" alt="The Last of Us Part II é um jogo eletrônico de ação-aventura desenvolvido pela Naughty Dog e publicado pela Sony Interactive Entertainment. É o segundo jogo da franquia e foi lançado em 19 de junho de 2020 exclusivamente para PlayStation 4."></a></div>
