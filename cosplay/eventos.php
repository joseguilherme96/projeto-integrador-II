    ...
    <section>
        ...
        <article>
          ...
          <div class="col-12 col-sm-6 col-lg-12 col-xl-6 pt-5"> 
              <h2 class="cor-letra">E3</h2> 
                <figure> 
                  <figcaption>
                      <img src="imgcosplay/E3evento.png" class="img-fluid"    alt="">
                  </figcaption>
                </figure>
          ...
          <div class="col-12 col-sm-6 col-lg-12 col-xl-6 pt-5">
              <h2 class="cor-letra">CCXP</h2>  
                <figure> 
                  <figcaption>
                      <img src="imgcosplay/ccxp.png"  class="img-fluid"  alt="">
                  </figcaption>
                </figure>
          ...
          <div class="col-12 col-sm-6 col-lg-12 col-xl-6 pb-5">
              <h2 class="cor-letra">Summer Game Fast  </h2> 
                <figure> 
                  <figcaption> 
                      <img src="imgcosplay/summergamerfast.png" class="img-fluid"   alt=""> 
                  </figcaption>
                </figure>
          ...
          <div class="col-12 col-sm-6 col-lg-12 col-xl-6 pb-5">
              <h2 class="cor-letra">Game XP</h2> <a href="https://www.gamexp.com.br">
                <figure> 
                  <figcaption> 
                      <img src="imgcosplay/GAMEXP.png" class="img-fluid"  alt=""> 
                  </figcaption>
                </figure>
