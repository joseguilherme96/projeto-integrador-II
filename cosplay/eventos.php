  ...
  <?php include "../nav.php"?>
    ...
    <main class="container text-center pt-5"> 
      <section>
        ...
        <div class="row col-12 col-sm-12 col-lg-12 col-xl-12 pt-5 "> 
        <figure>
          <figcaption>
            <img src="imgcosplay/eventos.png" alt="Esta é uma imagem">
          </figcaption>
        <figure>
        </div>
        ...
        <article>
        <div class="row col-12 col-sm-12 col-lg-12 col-xl-12 pt-5 ">
          <div class="col-6 col-sm-6 col-lg-12 col-xl-6 pt-5"> 
