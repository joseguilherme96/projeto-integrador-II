...
<body>
  ...
  <div class="container text-center">
    <div class="row justify-content-center">
      <picture>
        <source srcset="imgcosplay/bannernoticias.png " media="(min-width:1200px)" class="img-fluid">
        <source srcset="imgcosplay/bannernoticias2.png" media="(min-width:1150px)" class="img-fluid">
        <source srcset="imgcosplay/bannernoticias3.png" media="(min-width:1100px)" class="img-fluid">
        <source srcset="imgcosplay/bannernoticias4.png" media="(min-width:1000px)" class="img-fluid">
        <source srcset="imgcosplay/bannernoticias5.png" media="(min-width:950px)" class="img-fluid">
        <source srcset="imgcosplay/bannernoticias6.png" media="(min-width:850px)" class="img-fluid">
        <source srcset="imgcosplay/bannernoticias7.png" media="(min-width:750px)" class="img-fluid">
        <source srcset="imgcosplay/bannernoticias8.png" media="(min-width:600px)" class="img-fluid">
        <img src="imgcosplay/bannernoticias9.png" alt="Aqui você fica por dentro de todas as novidades no mundo gamer, nesta imagem é mostrado um conjunto de aparelhos gamers e tecnologias." class="img-fluid">
      </picture>
    </div>
