...
<body>
  ...
  <div class="container text-center">
    ...
    <picture>
        <source srcset="/projeto-integrador-II/imgcosplay//bannernoticias.png " media="(min-width:1200px)"  class="img-fluid">
        <source srcset="/projeto-integrador-II/imgcosplay//bannernoticias2.png" media="(min-width:1150px)" class="img-fluid">
        <source srcset="/projeto-integrador-II/imgcosplay//bannernoticias3.png" media="(min-width:1100px)" class="img-fluid">
        <source srcset="/projeto-integrador-II/imgcosplay//bannernoticias4.png" media="(min-width:1000px)" class="img-fluid">
        <source srcset="/projeto-integrador-II/imgcosplay//bannernoticias5.png" media="(min-width:950px)"  class="img-fluid">
    ...
    <div class="row pb-5 pt-5 justify-content-center">
      ...
      <div class="col-12 col-sm-3 col-lg-2 text-center"> <a href="https://www.animeunited.com.br/blog/ultimos-artigos/conheca-mais-sobre-a-historia-de-cuphead-e-sua-serie-animada-da-netflix/"><img src="/projeto-integrador-II/imgcosplay//cuphead.jpeg" alt="Cuphead
é um enorme lançamento, um dos mais bem sucedidos da historia. O sucesso do game foi tão grande, que ele ganhou uma série animada na Netflix que já está na terceira temporada."> </a>
      ...
      <div class="col-12 col-sm-12 col-lg-2 " > <a href="https://adrenaline.com.br/noticias/v/80731/8-de-junho-summer-game-fest-2023-acontecera-dias-antes-da-e3-2023"><img src="/projeto-integrador-II/imgcosplay//summergamerfast.jpg" alt="Summer Game Fast
Evento acontecerá dias antes do grande evento E3 2023. A próxima edição do Summer Game Fest já está marcada para acontecer a partir do dia 8 de junho."> </a>
    ...
    <div class="row pt-5 pb-5 justify-content-center">
      ...
      <div class="col-12  col-sm-12 col-lg-2 text-center" > <a href="https://animenew.com.br/god-of-war-ragnarok-cosplay-impecavel-deixa-fas-surpresos/"><img src="/projeto-integrador-II/imgcosplay//gowragnarok.png" alt="God of War Ragnarök
Cosplay surpreende fãs da grande franquia. Principalmente com o recém lançamendo do jogo God of War Ragnarök,que está sendo um sucesso absurdo."> </a>
      ...
      <div class="col-12  col-sm-12 col-lg-2 text-center" > <a href="https://www.ccxp.com.br"> <img src="/projeto-integrador-II/imgcosplay//ccxp.png" alt="CCXP
